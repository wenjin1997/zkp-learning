...
mod tests {
    ...
    #[test]
    fn plot_is_zero_example3() {
        use plotters::prelude::*;

        let root = BitMapBackend::new("is-zero-3-layout.png", (1024, 3096)).into_drawing_area();
        root.fill(&WHITE).unwrap();
        let root = root.titled("IsZero 3 Layout", ("sans-serif", 60)).unwrap();
